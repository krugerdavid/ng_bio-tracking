      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
          <div className="flex items-center justify-center mb-8">
            <img src="/ngtraining.png" alt="NG Training Logo" className="h-16 w-auto" />
          </div>

          <h2 className="text-3xl font-bold text-center mb-2 text-gray-900">Bienvenido a NG Training</h2>
