...
export class CreateUserUseCase {
  constructor(@inject(TYPES.UserDomain) private userDomain: UserDomain) {}

  async execute(data: CreateUserProfileDTO): Promise<Result<UserProfile>> {
    try {
      ...
      return Result.error(error instanceof Error ? error.message : "Unknown error creating user");
    }
  }
}
