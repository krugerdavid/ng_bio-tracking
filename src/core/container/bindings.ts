...
container
  .bind(TYPES.MemberRepository)
  .to(MemberRepositoryImpl)
  .inSingletonScope();

container
  .bind(TYPES.BioimpedanceRepository)
  .to(BioimpedanceRepositoryImpl)
  .inSingletonScope();

container
  .bind(TYPES.AuthRepository)
  .to(AuthRepositoryImpl)
  .inSingletonScope();

container
  .bind(TYPES.UserProfileRepository)
  .to(UserProfileRepositoryImpl)
  .inSingletonScope();

// Domain Services
container
  .bind(TYPES.MemberDomainService)
  .to(MemberDomainService)
  .inSingletonScope();

container
  .bind(TYPES.BioimpedanceDomainService)
  .to(BioimpedanceDomainService)
  .inSingletonScope();

container
  .bind(TYPES.AuthDomain)
  .to(AuthDomain)
  .inSingletonScope();

container
  .bind(TYPES.UserDomain)
  .to(UserDomain)
  .inSingletonScope();

// Use Cases - Member
container
  .bind(TYPES.RegisterMemberUseCase)
  .to(RegisterMemberUseCase)
  .inSingletonScope();

container
  .bind(TYPES.ListMembersUseCase)
  .to(ListMembersUseCase)
  .inSingletonScope();

container
  .bind(TYPES.GetMemberDetailsUseCase)
  .to(GetMemberDetailsUseCase)
  .inSingletonScope();

// Use Cases - Bioimpedance
container
  .bind(TYPES.RecordBioimpedanceUseCase)
  .to(RecordBioimpedanceUseCase)
  .inSingletonScope();
...
// Use Cases - Admin
container
  .bind(TYPES.CreateUserUseCase)
  .to(CreateUserUseCase)
  .inSingletonScope();

container
  .bind(TYPES.ListUsersUseCase)
  .to(ListUsersUseCase)
  .inSingletonScope();
